...
const Cards = ({ data, title }) => {
  return (
    <div className="flex flex-wrap w-full h-full px-4 sm:px-6 lg:px-8 bg-[#1F1E24] mt-8 justify-center overflow-x-hidden">
      <Link
        onClick={() => {
          window.scrollTo({
            top: 0,
      ...
      {data.map((c, i) => (
        <Link
          ...
          className="relative w-full sm:w-48 md:w-56 lg:w-64 xl:w-72 mx-2 my-4 bg-[#2b2b2b] rounded-lg overflow-hidden shadow-lg transform transition-transform duration-300 ease-in-out hover:scale-105"
          key={i}
        >
          ...
          <div className="p-2 sm:p-3 md:p-4">
            <h1 className="text-sm sm:text-base md:text-lg lg:text-xl text-zinc-300 font-semibold truncate">
